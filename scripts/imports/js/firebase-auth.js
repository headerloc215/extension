...
class UserImpl {
  ...
  static _fromJSON(e, t) {
    ...
    return (
      y &&
        Array.isArray(y) &&
        (w.providerData = y.map((e) => Object.assign({}, e))),
  ...
  pollUserCancellation() {
    const poll = () => {
      ...
      (
        ...
        : (this.pollId = window.setTimeout(poll, L.get()));
    };
    poll();
  }
}
...
export {
  ...
  R as browserLocalPersistence,
  G as browserPopupRedirectResolver,
  P as browserSessionPersistence,
  checkActionCode,
  ...
  getRedirectResult,
  A as inMemoryPersistence,
  b as indexedDBLocalPersistence,
  initializeAuth,
